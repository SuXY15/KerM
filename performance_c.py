...
plt.ylim([Tmin / 2, Tmax*50])
plt.xscale("log")
plt.yscale("log")
plt.xlabel("N")
plt.ylabel("Time Cost [s]")

fig, axs = plt.subplots(1, len(MMs), figsize=(4*len(MMs),3))
for i,mm in enumerate(MMs):
...
fig.subplots_adjust(left=0.2,bottom=0.20,top=0.9,right=0.98, wspace=0.0)
